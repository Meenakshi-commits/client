    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-600 to-purple-700 text-white">
      <header className="w-full flex justify-between p-6">
        <nav className="flex space-x-6">
          <button onClick={() => navigate('/')} className="text-white hover:underline">Home</button>
          <button onClick={() => navigate('/about-us')} className="text-white hover:underline">About Us</button>
          <button onClick={() => navigate('/contact-us')} className="text-white hover:underline">Contact Us</button>
        </nav>
        <div>
          <button onClick={() => navigate('/login')} className="text-white hover:underline">Login</button>
          <button onClick={() => navigate('/signup')} className="ml-4 text-white hover:underline">Sign Up</button>
        </div>
      </header>
