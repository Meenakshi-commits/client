...
const API_URL = 'https://server-production-d135.up.railway.app/api'; // Ensure this matches the backend base URL
...
export const signup = async (data) => {
  const response = await apiService.post('/auth/signup', data); // Ensure this endpoint matches the backend route
  return response.data;
};
